package com.workintech.models.Challange;

import java.util.Collections;
import java.util.HashSet;
import java.util.LinkedHashSet;

public class TextProccesingChallange {
    public static void main(String[] args) {
        ...
        LinkedHashSet<String> linkedUniqueWords = new LinkedHashSet<>(uniqueWords);

        for(String word: linkedUniqueWords) {
            System.out.println(word);
        }
        System.out.println("Toplam unique kelime sayisi: " +linkedUniqueWords.size());
